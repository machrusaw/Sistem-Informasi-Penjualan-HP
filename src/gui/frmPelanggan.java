...
public class frmPelanggan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "DATA PELANGGAN", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        getContentPane().add(btnHapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 450, 122, 36));
        ...
        hapusall.setText("CLEAR ALL");
        hapusall.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                hapusallActionPerformed(evt);
            }
        });
        getContentPane().add(hapusall, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 450, 120, 40));
...
boolean edit = false;
    ...
    private void hapusallActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusallActionPerformed
        ...
        int opsi = JOptionPane.showConfirmDialog(null, "APAKAH ANDA YAKIN INGIN MENGHAPUS SEMUA DATA?", 
                "Penghapusan Data", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        ...
        if (opsi == JOptionPane.YES_OPTION){
            try {
                String kode = txid.getText();
            pl.hapusallPLG(kode);
                   JOptionPane.showMessageDialog(rootPane, "SEMUA DATA BERHASIL DI HAPUS");
            tampil();
            clear();
