...
public class frmUser extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        getContentPane().add(kGradientPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(373, 0, 721, 460));

        jPanel1.setBackground(new java.awt.Color(215, 215, 215));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ENTRY ADMIN", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        txPertanyaan.setEditable(false);
        txPertanyaan.setText("Berapa nomer hp anda?");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txPertanyaan, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnSimpan, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 13, -1, 450));
        jPanel1.getAccessibleContext().setAccessibleName("ENTRY ADMIN");
        ...
        getContentPane().add(btnHapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 490, 122, 36));
        ...
        getContentPane().add(btnNew, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 490, 122, 36));
        ...
        getContentPane().add(btnCancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 490, 122, 36));
        ...
        getContentPane().add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 490, 122, 36));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 470, 122, 70));
...
boolean edit = false;
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if(edit==true){
            ...
            String pertanyaan = txPertanyaan.getText();
            String nohp = txNohp.getText();
            
            try {
                ur.edit(id,user,pass,nama,pertanyaan,nohp);
        ...
        btnNew.setEnabled(true);
           ...
           String id = txId.getText();
            ...
            String nohp = txNohp.getText();
        try {
            ur.simpan(id, user, pass, nama, pertanyaan, nohp);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         FormUtama.user.setText(user.getText());
        ut.tampilCountTrx();
        dispose();
